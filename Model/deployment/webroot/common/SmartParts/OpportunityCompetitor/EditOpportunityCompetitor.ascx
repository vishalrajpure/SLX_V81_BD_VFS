...
<asp:TextBox runat="server" ID="txtCompetitorRate"  Rows="2" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
  </div>
...
public class EditOpportunityCompetitorAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IEditOpportunityCompetitor
{
    ...
    private Sage.Platform.Controls.ITextBoxControl _txtCompetitorRate;
    public  Sage.Platform.Controls.ITextBoxControl txtCompetitorRate
    {
