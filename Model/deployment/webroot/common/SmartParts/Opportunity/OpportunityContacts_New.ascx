<%@ Control Language="C#" ClassName="OpportunityContacts_New" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
AlternatingRowStyle-CssClass="rowdk" RowStyle-CssClass="rowlt" SelectedRowStyle-CssClass="rowSelected" ShowEmptyTable="true" EnableViewState="false"
 ...
 DataKeyNames="InstanceId,Opportunity.Id,Contact.Id"
...
protected void grdOppContacts_RowCommand(object sender, GridViewCommandEventArgs e)
{
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="OpportunityContacts_New_RTools" ToolbarLocation="right">
...
<LookupProperties>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateContacts.LookupProperties.Name.PropertyHeader %>" PropertyName="Name" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
...
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueAssociateContacts.LookupProperties.Phone.PropertyHeader %>" PropertyName="Phone" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=OpportunityContacts_New&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkOpportunityContacts_NewHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="OpportunityContacts_New" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
   ...
   dsOpportunityContacts.BindFieldNames = new String[] { "Opportunity.Id","Contact.Id","Contact.NameLF","Contact.Title","SalesRole","Contact.IsPrimary","Contact.WorkPhone","Contact.Email" };
...
lib.Execute("OpportunityContacts_New.lueAssociateContacts_OnChange", methodArgs);
...
{
    get { return _formAdapter ?? (_formAdapter = new OpportunityContacts_NewAdapter(this)); }
}

public class OpportunityContacts_NewAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IOpportunityContacts_New
{
    public OpportunityContacts_NewAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
