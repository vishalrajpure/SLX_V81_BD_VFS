<%@ Control Language="C#" ClassName="OpportunityProductsNew" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
AlternatingRowStyle-CssClass="rowdk" RowStyle-CssClass="rowlt" SelectedRowStyle-CssClass="rowSelected" ShowEmptyTable="true" EnableViewState="false"
 ...
 DataKeyNames="InstanceId,OpportunityId,ProductId"
...
<Columns>
   <asp:BoundField DataField="Product.Name"
      HeaderText="<%$ resources: grdOppProducts.020f00eb-40a7-4c7d-9178-8909d29d43b1.ColumnHeading %>"          >
      </asp:BoundField>
    <asp:BoundField DataField="Product.Family"
      HeaderText="<%$ resources: grdOppProducts.a9c05a3b-534d-4def-8dea-3e15209dfc8d.ColumnHeading %>"          >
      </asp:BoundField>
...
protected void grdOppProducts_RowCommand(object sender, GridViewCommandEventArgs e)
{
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="OpportunityProductsNew_RTools" ToolbarLocation="right">
...
<LookupPreFilters>
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=OpportunityProductsNew&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkOpportunityProductsNewHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="OpportunityProductsNew" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
   ...
   dsOpportunityProducts.BindFieldNames = new String[] { "OpportunityId","ProductId","Product.Name","Product.Family" };
...
lib.Execute("OpportunityProductsNew.lueAssociateProduct_OnChange", methodArgs);
...
{
    get { return _formAdapter ?? (_formAdapter = new OpportunityProductsNewAdapter(this)); }
}

public class OpportunityProductsNewAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IOpportunityProductsNew
{
    public OpportunityProductsNewAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
