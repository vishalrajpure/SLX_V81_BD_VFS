...
<asp:TextBox runat="server" ID="txtReference"  dojoType="Sage.UI.Controls.TextBox"  />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtPONumber"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
Enabled="false" LabelPlacement="right" AutoPostBack="true"  />
</div>
      </td>
                <td  >
<div class=" lbl alignleft">
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtGracePeriod"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
