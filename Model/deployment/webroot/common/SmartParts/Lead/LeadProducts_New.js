...
Sage.UI.Forms.LeadProducts_New = {
...
makeGrid : function(runtimeConfig) {
    ...
    if (typeof LeadProducts_NewgrdLeadProducts_Strings === 'undefined') {
        LeadProducts_NewgrdLeadProducts_Strings = {};
    }
...

{
    ...
    if (Sage.Utility.getModeId() === 'insert') {
		...
		name:  LeadProducts_NewgrdLeadProducts_Strings['grdLeadProducts_6ef4d952_2b1a_4d9f_a36e_35a942dd32bb_ColumnHeading']  || '',
	sortable: false,
		width: 4,
		styles: 'width:auto;',
...
,
	   	type: SlxEdit,
		cellValue: LeadProducts_NewgrdLeadProducts_Strings['grdLeadProducts_6ef4d952_2b1a_4d9f_a36e_35a942dd32bb_Text']  || 'Edit',
		entityType: 'Sage.Entity.Interfaces.ILeadProduct, Sage.Entity.Interfaces',
		smartPart: 'EditLeadProduct',
		dialogTitle: LeadProducts_NewgrdLeadProducts_Strings['38611e40_47c3_4f73_88e1_62bfa47171a4_DialogTitleOverride'] || '',
		isCentered: true ,
		dialogTop: 0,
		dialogLeft: 0,
		dialogHeight: 360,
		dialogWidth: 600,
    	formObjectName: 'Sage.UI.Forms.LeadProducts_New'
    	    }
  	,
{
		field: 'Product.Name',
				name:  LeadProducts_NewgrdLeadProducts_Strings['grdLeadProducts_5e29a114_4a97_45a3_9db6_2d0b10fd74dd_ColumnHeading']  || 'Product',
	sortable: true,
		width: 15,
		styles: 'width:auto;',
  	...
  	,
{
		field: 'Product.Family',
				name:  LeadProducts_NewgrdLeadProducts_Strings['grdLeadProducts_89fb1ecc_72a4_4f09_921b_29a9175daf56_ColumnHeading']  || 'Family',
	sortable: true,
		width: 6,
		styles: 'width:auto;',
    cellClasses: '  alignleft ',
...
, 
	...
	editable: false
	    ...
	    //The .net vehicle to store grid data on postback
            dataCarrierId: 'LeadProducts_NewgrdLeadProducts_DataCarrier',
            sort: [
                  ]
        },
        tools: [
...
{
    id : 'LeadProducts_New_Save',
  displayInInsert : false,
  imageClass: 'icon_Save_16x16',  'alternateText' : LeadProducts_NewgrdLeadProducts_Strings['grdLeadProducts_Save_ToolTip'] || 'Save',
         'handler' : function() {
...
{
  id : 'lueProduct',
  btnToolTip :  LeadProducts_NewlueProduct_Strings['lueProduct_ButtonTooltip']  ||  'Include Product', 
  btnIcon:  '~/ImageResource.axd?scope=global&type=Global_Images&key=add_products_16x16'  ,
  dialogButtonText : LeadProducts_NewlueProduct_Strings['lueProduct_DialogButtonText']  ||  'Add Selected', 
  displayMode : 4, //$ {qf control . LookupDisplayMode}  When adding other dijit templates, need to convert control to use enum values
  dialogTitle : LeadProducts_NewlueProduct_Strings['lueProduct_LookupDialogTitle']  ||  'Lookup Product',
      structure : [
     {
       ...
       cells: [
		...
		return anchor;
		 ...
		 {
		   name: LeadProducts_NewlueProduct_Strings['lueProduct_LookupProperties_Name_PropertyHeader']  || 'Name',
		   field: 'Name',
         ...
         ,
		 {
		   name: LeadProducts_NewlueProduct_Strings['lueProduct_LookupProperties_Family_PropertyHeader']  || 'Family',
		   field: 'Family',
		   propertyType: 'System.String',
		   				   excludeFromFilters: false,		   
		   		   width: 12,
         ...
         ,
		 {
		   name: LeadProducts_NewlueProduct_Strings['lueProduct_LookupProperties_Status_PropertyHeader']  || 'Status',
		   field: 'Status',
		   propertyType: 'System.String',
		   				   excludeFromFilters: false,		   
		   		   width: 12,
         ...
         ,
		 {
		   name: LeadProducts_NewlueProduct_Strings['lueProduct_LookupProperties_ActualId_PropertyHeader']  || 'SKU',
		   field: 'ActualId',
		   propertyType: 'System.String',
		   				   excludeFromFilters: false,		   
		   		   width: 12,
...
function (items) {
  ...
  ,
{
    id : 'LeadProducts_New_Cancel',
  displayInInsert : false,
  imageClass: 'icon_Reset_16x16',  'alternateText' : LeadProducts_NewgrdLeadProducts_Strings['grdLeadProducts_Cancel_ToolTip'] || 'Revert Changes',
          'handler' : function() { this.cancelChanges(); }
}
  ,
{
    id : 'LeadProducts_New_Delete',
  displayInInsert : true,
  imageClass: 'icon_Delete_16x16',  'alternateText' : LeadProducts_NewgrdLeadProducts_Strings['grdLeadProducts_Delete_ToolTip'] || 'Remove',
    ...
    if ((attribute === 'Discount') || (attribute === 'CalculatedPrice') || (attribute === 'Quantity')) {
		...
		gridNodeId: 'LeadProducts_NewgrdLeadProducts_Grid',
				id : 'LeadProducts_NewgrdLeadProducts',
        rowsPerPage: 21,
  ...
  ,
    ...
    init : function(runtimeConfig) {
        setTimeout(function() { Sage.UI.Forms.LeadProducts_New.makeGrid(runtimeConfig); }, 1);
