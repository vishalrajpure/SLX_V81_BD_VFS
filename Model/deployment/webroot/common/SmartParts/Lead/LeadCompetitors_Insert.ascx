<%@ Control Language="C#" ClassName="LeadCompetitors_Insert" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
protected void grdLeadCompetitors_RowCommand(object sender, GridViewCommandEventArgs e)
{
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="LeadCompetitors_Insert_RTools" ToolbarLocation="right">
   <SalesLogix:LookupControl runat="server" ID="lueLeadCompetitor" LookupEntityName="Competitor" LookupEntityTypeName="Sage.Entity.Interfaces.ICompetitor, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" LookupDisplayMode="ButtonOnly" AutoPostBack="true" LookupImageURL="~/ImageResource.axd?scope=global&type=Global_Images&key=plus_16x16"  >
<LookupProperties>
...
<LookupPreFilters>
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=LeadCompetitors_Insert&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkLeadCompetitors_InsertHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="LeadCompetitors_Insert" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
   ...
   dsLeadCompetitors.BindFieldNames = new String[] { "Leadid","CompetitorID","Competitor.CompetitorName","Competitor","Competitor.Rating","RATING","Competitor.Weaknesses","WEAKNESSES","CurrentMajorCompetitor","COMPETITORRATE","COMPETITORSHAREOFWELLET" };
...
lib.Execute("LeadCompetitors_Insert.lueLeadCompetitor_OnChange", methodArgs);
...
{
    get { return _formAdapter ?? (_formAdapter = new LeadCompetitors_InsertAdapter(this)); }
}

public class LeadCompetitors_InsertAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.ILeadCompetitors_Insert
{
    public LeadCompetitors_InsertAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
