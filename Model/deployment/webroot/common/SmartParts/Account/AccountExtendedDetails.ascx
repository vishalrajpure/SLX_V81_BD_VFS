...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="Region" PickListName="Region" MustExistInList="false"  />
  </div>
...
MaxLength="32"  />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="ImportSource" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox" MaxLength="24"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="Ticker"  dojoType="Sage.UI.Controls.TextBox" MaxLength="16"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="SicCode"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>
...
<LookupPreFilters>
<SalesLogix:LookupPreFilter PropertyName="Status" PropertyType="System.String" OperatorCode="=" Visible="True"
...
<tr>
            <td  >
 <div class=" lbl alignleft">
   <asp:Label ID="lueCurrency_lbl" AssociatedControlID="lueCurrency" runat="server" Text="<%$ resources: lueCurrency.Caption %>" ></asp:Label>
 </div>   
  <div   class="textcontrol lookup"   >
<SalesLogix:LookupControl runat="server" ID="lueCurrency" ButtonToolTip="<%$ resources: lueCurrency.ButtonToolTip %>" Enabled="false" LookupEntityName="ExchangeRate" LookupEntityTypeName="Sage.Entity.Interfaces.IExchangeRate, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" LookupBindingMode="String"  >
<LookupProperties>
