...
<SalesLogix:LookupControl runat="server" ID="lueAccountName" ReadOnly="true" EnableLookup="false" LookupEntityName="Account" LookupEntityTypeName="Sage.Entity.Interfaces.IAccount, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" EnableHyperLinking="true"  >
<LookupProperties>
</LookupProperties>
<LookupPreFilters>
</LookupPreFilters>
...
<asp:ListBox runat="server" ID="cboPreferredContact"  SelectionMode="Single" Rows="1" data-dojo-type="dijit.form.Select"  CssClass="select-control "  >
...
protected override void OnAddEntityBindings() {
        ...
        Sage.Platform.WebPortal.Binding.WebEntityBinding lueAccountNameLookupResultValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("Account", lueAccountName, "LookupResultValue");
        ...
        BindingSource.Bindings.Add(adrContactAddressAddressStateBinding);
                 // adrContactAddress.AddressType Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding adrContactAddressAddressTypeBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("Address.AddressType", adrContactAddress, "AddressType");
        adrContactAddressAddressTypeBinding.IgnoreFLSDisabling = true;
        BindingSource.Bindings.Add(adrContactAddressAddressTypeBinding);
                 // adrContactAddress.PrimaryAddress Binding
...
if (DialogService != null)
{
	...
	if(contact != null)
	{
		 string _idname = contact.Address.Id.ToString() + ",Contact," + contact.Id.ToString() ;
...
{
cmdCopyContact.Click += new ImageClickEventHandler(cmdCopyContact_ClickAction);
}
}
