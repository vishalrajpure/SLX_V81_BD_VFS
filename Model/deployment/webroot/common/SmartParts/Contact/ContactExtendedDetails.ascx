...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtSpouse"  dojoType="Sage.UI.Controls.TextBox" MaxLength="64"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtChildren"  dojoType="Sage.UI.Controls.TextBox" MaxLength="64"  />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklDepartment" PickListName="Department" MustExistInList="false" AlphaSort="true"  />
  </div>

      </td>
                <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="txtPreferredName_lbl" AssociatedControlID="txtPreferredName" runat="server" Text="<%$ resources: txtPreferredName.Caption %>" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtPreferredName"  dojoType="Sage.UI.Controls.TextBox" MaxLength="32"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtAlumni"  dojoType="Sage.UI.Controls.TextBox" MaxLength="64"  />
  </div>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtReferral"  dojoType="Sage.UI.Controls.TextBox" MaxLength="64"  />
  </div>

      </td>
                <td  >
 <div class=" lbl alignleft">
   <asp:Label ID="pklGender_lbl" AssociatedControlID="pklGender" runat="server" Text="<%$ resources: pklGender.Caption %>" ></asp:Label>
 </div>   
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklGender" PickListName="IC Gender" MustExistInList="false"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtPreviousEmployer"  dojoType="Sage.UI.Controls.TextBox" MaxLength="64"  />
  </div>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtEntityId" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox"  />
  </div>

      </td>
                <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="pklMaritalStatus_lbl" AssociatedControlID="pklMaritalStatus" runat="server" Text="<%$ resources: pklMaritalStatus.Caption %>" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="pklMaritalStatus"  dojoType="Sage.UI.Controls.TextBox" MaxLength="32"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklInterests" PickListName="Interests" MustExistInList="false" AllowMultiples="true" AlphaSort="true" MaxLength="128"  />
  </div>
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="txtImportSource" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox" MaxLength="24"  />
  </div>

      </td>
                <td  >
 <div class=" lbl alignleft">
   <asp:Label ID="pklCompanyContext_lbl" AssociatedControlID="pklCompanyContext" runat="server" Text="<%$ resources: pklCompanyContext.Caption %>" ></asp:Label>
 </div>   
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklCompanyContext" PickListName="IC Company Context" MustExistInList="false"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklCuisinePreference" PickListName="CuisinePrefs" MustExistInList="false" AllowMultiples="true" AlphaSort="true" MaxLength="64"  />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol"  > 
    <SalesLogix:SlxUserControl runat="server" ID="usrCreateUser" ReadOnly="true" LookupBindingMode="String" ButtonToolTip="<%$ resources: usrCreateUser.ButtonToolTip %>"  />
                ...
                <td  >
 <div class=" lbl alignleft" >
   <asp:Label ID="pklNationality_lbl" AssociatedControlID="pklNationality" runat="server" Text="<%$ resources: pklNationality.Caption %>" ></asp:Label>
 </div>
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="pklNationality"  dojoType="Sage.UI.Controls.TextBox" MaxLength="64"  />
  </div>
...
MaxLength="32"  />
 ...
 <div class=" lbl alignleft" >
  ...
  <div  class="textcontrol"   >
<asp:TextBox runat="server" ID="pklLanguage"  dojoType="Sage.UI.Controls.TextBox" MaxLength="2"  />
  </div>
...
<tr>
 ...
 AlternateText="<%$ resources: cmdSaveContactExtendedDetails.Caption %>"  ToolTip="<%$ resources: cmdSaveContactExtendedDetails.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=ContactExtendedDetails&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkContactExtendedDetailsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="ContactExtendedDetails" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected override void OnAddEntityBindings() {
        ...
        BindingSource.Bindings.Add(pklDepartmentPickListValueBinding);
                    // txtPreferredName.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding txtPreferredNameTextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("PreferredName", txtPreferredName, "Text");
        BindingSource.Bindings.Add(txtPreferredNameTextBinding);
        ...
        BindingSource.Bindings.Add(txtReferralTextBinding);
                    // pklGender.PickListValue Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding pklGenderPickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("Gender", pklGender, "PickListValue");
        BindingSource.Bindings.Add(pklGenderPickListValueBinding);
        ...
        BindingSource.Bindings.Add(txtEntityIdTextBinding);
                    // pklMaritalStatus.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding pklMaritalStatusTextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("MaritalStatus", pklMaritalStatus, "Text");
        BindingSource.Bindings.Add(pklMaritalStatusTextBinding);
        ...
        BindingSource.Bindings.Add(txtImportSourceTextBinding);
                    // pklCompanyContext.PickListValue Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding pklCompanyContextPickListValueBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("CompanyContext", pklCompanyContext, "PickListValue");
        BindingSource.Bindings.Add(pklCompanyContextPickListValueBinding);
        ...
        BindingSource.Bindings.Add(usrCreateUserLookupResultValueBinding);
                    // pklNationality.Text Binding
        Sage.Platform.WebPortal.Binding.WebEntityBinding pklNationalityTextBinding = new Sage.Platform.WebPortal.Binding.WebEntityBinding("Nationality", pklNationality, "Text");
        BindingSource.Bindings.Add(pklNationalityTextBinding);
...
public class ContactExtendedDetailsAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IContactExtendedDetails
{
    ...
    private Sage.Platform.Controls.ITextBoxControl _txtPreferredName;
    public  Sage.Platform.Controls.ITextBoxControl txtPreferredName
    {
        get { return FindControl(ref _txtPreferredName, "txtPreferredName"); }
    }
    private Sage.Platform.Controls.IPickListControl _pklGender;
    public  Sage.Platform.Controls.IPickListControl pklGender
    {
        get { return FindControl(ref _pklGender, "pklGender"); }
    }
    private Sage.Platform.Controls.ITextBoxControl _pklMaritalStatus;
    public  Sage.Platform.Controls.ITextBoxControl pklMaritalStatus
    {
        get { return FindControl(ref _pklMaritalStatus, "pklMaritalStatus"); }
    }
    private Sage.Platform.Controls.IPickListControl _pklCompanyContext;
    public  Sage.Platform.Controls.IPickListControl pklCompanyContext
    {
        get { return FindControl(ref _pklCompanyContext, "pklCompanyContext"); }
    }
    private Sage.Platform.Controls.ITextBoxControl _pklNationality;
    public  Sage.Platform.Controls.ITextBoxControl pklNationality
    {
        get { return FindControl(ref _pklNationality, "pklNationality"); }
    }
    private Sage.Platform.Controls.ITextBoxControl _pklLanguage;
