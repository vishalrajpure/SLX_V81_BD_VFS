...
<tr>
            <td></td>
                <td  >
<asp:Panel runat="server" ID="btnsControlList" CssClass="controlslist qfActionContainer"
>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="SelectAccountAddress_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=SelectAccountAddress&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkSelectAccountAddressHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="SelectAccountAddress" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
if (dtsAddresses.Current != null)
{
    if (((Sage.Platform.ComponentModel.ComponentView)dtsAddresses.Current).IsVirtualComponent)
    {
        throw new Sage.Platform.Application.ValidationException(GetLocalResourceObject("error_NoAddressSelected").ToString());
    }
    ...
    Sage.Entity.Interfaces.IAddress address =
        ((Sage.Platform.ComponentModel.ComponentView)dtsAddresses.Current).Component as
        Sage.Entity.Interfaces.IAddress;
