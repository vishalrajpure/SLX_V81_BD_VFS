<%@ Control Language="C#" ClassName="EditLeadCompetitor" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="EditLeadCompetitor_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=EditLeadCompetitor&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkEditLeadCompetitorHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="EditLeadCompetitor" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
{
    get { return typeof(Sage.Entity.Interfaces.ILeadCompetitor); }
}
...
protected void btnOk_ClickAction(object sender, EventArgs e) {
  Sage.Entity.Interfaces.ILeadCompetitor _entity = BindingSource.Current as Sage.Entity.Interfaces.ILeadCompetitor;
  if (_entity != null)
  {
...
{
    get { return _formAdapter ?? (_formAdapter = new EditLeadCompetitorAdapter(this)); }
}

public class EditLeadCompetitorAdapter : Sage.Platform.WebPortal.Adapters.EntityFormAdapter, Sage.Form.Interfaces.IEditLeadCompetitor
{
    public EditLeadCompetitorAdapter(Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider smartPart)
        : base(smartPart) {}
