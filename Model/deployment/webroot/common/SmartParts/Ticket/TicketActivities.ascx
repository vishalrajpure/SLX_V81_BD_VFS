<%@ Control Language="C#" ClassName="TicketActivities" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<asp:TextBox runat="server" ID="txtComments"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
   ...
   <asp:ImageButton runat="server" ID="cmdCommentsDateStamp"
 ToolTip="<%$ resources: cmdCommentsDateStamp.ToolTip %>" CssClass="qfButtonContainer" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=User_Date_Stamp_16x16"  />
 
</asp:Panel>
      </td>
                      <td  >
 <asp:Button runat="server" ID="cmdAdvanced"
 Text="<%$ resources: cmdAdvanced.Caption %>" CssClass="slxbutton"  />
...
<SalesLogix:ScriptResourceProvider ID="TicketActivitiesgrdTicketActivities_Strings" runat="server">
    <Keys>
...
<div style="display:none;">
  <asp:TextBox runat="server" ID="TicketActivitiesgrdTicketActivities_DataCarrier" class="TicketActivitiesgrdTicketActivities_DataCarrier" ></asp:TextBox>
</div>
  <div id="TicketActivitiesgrdTicketActivities_Container" style="width:100%;height:100%;" class="">
    <div id="TicketActivitiesgrdTicketActivities_Grid" style="width:100%;height:100%;"
></div>
</div>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="TicketActivities_RTools" ToolbarLocation="right">
    <asp:ImageButton runat="server" ID="cmdTicketActivities"
 AlternateText="<%$ resources: cmdTicketActivities.Caption %>"  ToolTip="<%$ resources: cmdTicketActivities.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  OnClientClick="return cmdTicketActivities_ClientClick(); " 
   />
   
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=TicketActivities&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkTicketActivitiesHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="TicketActivities" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
protected void cmdCommentsDateStamp_ClickAction(object sender, EventArgs e) {
                              object[] objarray = new object[] { this.BindingSource.Current, dtsTicketActivityDataSource.Current };
         Sage.Platform.EntityFactory.Execute<Sage.Entity.Interfaces.ITicket>("Ticket.AddTicketActivityCommentsTimeStamp", objarray);

  
}
protected void cmdAdvanced_ClickAction(object sender, EventArgs e) {
    Session.Add("TicketActivityComments", txtComments.Text);
    Response.Redirect("InsertTicketActivity.aspx?modeid=insert");

}
protected void cmdTicketActivities_ClickAction(object sender, EventArgs e) {
                                        object[] objarray = new object[] {   dtsTicketActivityDataSource.Current, this.BindingSource.Current };
         Sage.Platform.EntityFactory.Execute<Sage.Entity.Interfaces.ITicket>("TicketActivity.AddTicketActivityEx", objarray);

          cmdTicketActivities_ClickActionBRC(sender, e);
    
  
}
protected void cmdTicketActivities_ClickActionBRC(object sender, EventArgs e) {
...
protected override void OnWireEventHandlers()
{
 ...
 cmdCommentsDateStamp.Click += new ImageClickEventHandler(cmdCommentsDateStamp_ClickAction);
cmdAdvanced.Click += new EventHandler(cmdAdvanced_ClickAction);
cmdTicketActivities.Click += new ImageClickEventHandler(cmdTicketActivities_ClickAction);
...
ScriptManager.RegisterStartupScript(Page, GetType(), "cleanupcontainer", "jQuery(\".controlslist > div:empty\").remove();", true);
 ...
 if (entity != null) 
      ...
      { 
          ...
          TicketActivitiesgrdTicketActivities_DataCarrier.Text = text; 
          entity.TicketActivities.Clear(); 
      } 
 } 
ClientBindingMgr.RegisterSaveButton(cmdTicketActivities);
...
dtsTicketActivityDataSource.Bind();
                                ...
                                script.AppendLine("require(['" + Page.ResolveUrl("~/SmartParts/Ticket/TicketActivities.js") + "'], function () {");
                                if (Page.IsPostBack)
                                {
