<%@ Control Language="C#" ClassName="TicketHistory_PrintView" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<SalesLogix:OwnerControl runat="server" ID="ownReceivedBy" ButtonToolTip="<%$ resources: ownReceivedBy.ButtonToolTip %>" AutoPostBack="true" DisplayMode="AsText" Types="$qfcontrol.Types"  />
  </div>

      </td>
                <td  >
  <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dtpReceivedDate" ButtonToolTip="<%$ resources: dtpReceivedDate.ButtonToolTip %>" DisplayMode="AsText" />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol"  > 
    <SalesLogix:SlxUserControl runat="server" ID="usrCreateUser" ReadOnly="true" DisplayMode="AsText"  />
  </div>

      </td>
                <td  >
  <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dtpCreateDate" ReadOnly="true" DisplayMode="AsText" />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol"  > 
<SalesLogix:OwnerControl runat="server" ID="ownCompletedBy" ButtonToolTip="<%$ resources: ownCompletedBy.ButtonToolTip %>" AutoPostBack="true" DisplayMode="AsText" Types="$qfcontrol.Types"  />
  </div>

      </td>
                <td  >
  <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dtpCompletedDate" ButtonToolTip="<%$ resources: dtpCompletedDate.ButtonToolTip %>" DisplayMode="AsText" />
  </div>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol"  > 
    <SalesLogix:SlxUserControl runat="server" ID="usrModifyUser" ReadOnly="true" DisplayMode="AsText"  />
  </div>

      </td>
                <td  >
  <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dtpModifyDate" ReadOnly="true" DisplayMode="AsText" />
  </div>
...
<SalesLogix:ScriptResourceProvider ID="TicketHistory_PrintViewQFSDataGrid_Strings" runat="server">
    <Keys>
  ...
  <div id="TicketHistory_PrintViewQFSDataGrid_Container" style="width:100%;height:100%;" class="">
    <div id="TicketHistory_PrintViewQFSDataGrid_Grid" style="width:100%;height:100%;"
...
<tr>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="TicketHistory_PrintView_RTools" ToolbarLocation="right">
   
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=TicketHistory_PrintView&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkTicketHistory_PrintViewHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="TicketHistory" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
