...
<SalesLogix:LookupPreFilter PropertyName="AllowWebTicket" PropertyType="System.Boolean" OperatorCode="=" Visible="False"
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklStatusCode" ReadOnly="true" PickListName="Ticket Status" AlphaSort="true" StorageMode="ID"  />
  </div>
...
<asp:TextBox runat="server" ID="txtSubject" ReadOnly="true"  dojoType="Sage.UI.Controls.TextBox" MaxLength="255"  />
  </div>
...
<asp:TextBox runat="server" ID="txtDescription" ReadOnly="true"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea" MultiLineMaxLength="2147483647"  />
  </div>
...
<tr>
 ...
 <div class=" lbl colspan3 alignleft" >
  ...
  <div  class="threecoltextcontrol"   >
<asp:TextBox runat="server" ID="txtResolution" ReadOnly="true"  Rows="3" TextMode="MultiLine" Columns="40" dojoType="Sage.UI.Controls.SimpleTextarea"  />
  </div>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="PortalTicket_RTools" ToolbarLocation="right">
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=PortalTicket&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkPortalTicketHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="PortalTicket" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
