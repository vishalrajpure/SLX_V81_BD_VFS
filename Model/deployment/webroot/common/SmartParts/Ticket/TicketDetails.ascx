<%@ Control Language="C#" ClassName="TicketDetails" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<SalesLogix:LookupControl runat="server" ID="lueAccount" ButtonToolTip="<%$ resources: lueAccount.ButtonToolTip %>" LookupEntityName="Account" LookupEntityTypeName="Sage.SalesLogix.Entities.Account, Sage.SalesLogix.Entities" EnableHyperLinking="true" AutoPostBack="true"  >
<LookupProperties>
...
<tr>
 ...
 <div class=" lbl alignleft">
  ...
  <div   class="textcontrol lookup"   >
<SalesLogix:LookupControl runat="server" ID="lueContact" ButtonToolTip="<%$ resources: lueContact.ButtonToolTip %>" LookupEntityName="Contact" LookupEntityTypeName="Sage.SalesLogix.Entities.Contact, Sage.SalesLogix.Entities" SeedProperty="Account.Id" EnableHyperLinking="true" AutoPostBack="true"  >
<LookupProperties>
...
<tr>
 ...
 <div class=" lbl alignleft">
  ...
  <div   class="textcontrol lookup"   >
<SalesLogix:LookupControl runat="server" ID="lueContract" ButtonToolTip="<%$ resources: lueContract.ButtonToolTip %>" LookupEntityName="Contract" LookupEntityTypeName="Sage.SalesLogix.Entities.Contract, Sage.SalesLogix.Entities" SeedProperty="Account.Id" EnableHyperLinking="true" AutoPostBack="true"  >
<LookupProperties>
...
<SalesLogix:Email runat="server" ID="emlAssignToEmail" ReadOnly="true" ButtonToolTip="<%$ resources: emlAssignToEmail.ButtonToolTip %>" EmailTextBoxStyle-ForeColor="#000099" EmailTextBoxStyle-Font-Underline="false" />
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="TicketDetails_RTools" ToolbarLocation="right">
 ...
 AlternateText="<%$ resources: cmdAccountService.Caption %>"  ToolTip="<%$ resources: cmdAccountService.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Account_Service_Information_16x16"  />
    ...
    <SalesLogix:PageLink runat="server" ID="lnkPrintViewLink" NavigateUrl="TicketDetailPrintView"
  LinkType="PageAlias"   ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Print_View_16x16"     ToolTip="<%$ resources: lnkPrintViewLink.ToolTip %>"     ></SalesLogix:PageLink>
 ...
 />
  ...
  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=TicketDetails&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkTicketDetailsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="TicketDetails" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
