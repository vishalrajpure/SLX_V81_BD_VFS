<%@ Control Language="C#" ClassName="PortalTicket_PrintView" Inherits="Sage.Platform.WebPortal.SmartParts.EntityBoundSmartPartInfoProvider" %>
...
<DependentLookups>
 ...
 <div class=" lbl alignleft">
  ...
  <div    >
<SalesLogix:LookupControl runat="server" ID="lueUrgency" ButtonToolTip="<%$ resources: lueUrgency.ButtonToolTip %>" ReadOnly="true" EnableLookup="false" LookupEntityName="Urgency" LookupEntityTypeName="Sage.SalesLogix.Entities.Urgency, Sage.SalesLogix.Entities" LookupDisplayMode="Text" AddEmptyListItem="false"  >
<LookupProperties>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueUrgency.LookupProperties.Description.PropertyHeader %>" PropertyName="Description" PropertyType="System.String" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
<SalesLogix:LookupProperty PropertyHeader="<%$ resources: lueUrgency.LookupProperties.AllowWebTicket.PropertyHeader %>" PropertyName="AllowWebTicket" PropertyType="System.Boolean" PropertyFormat="None" PropertyFormatString="" UseAsResult="True" ExcludeFromFilters="False"></SalesLogix:LookupProperty>
</LookupProperties>
<LookupPreFilters>
<SalesLogix:LookupPreFilter PropertyName="AllowWebTicket" PropertyType="System.Boolean" OperatorCode="=" Visible="False"
 FilterValue="True"
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol picklist"  > 
    <SalesLogix:PickListControl runat="server" ID="pklStatusCode" ReadOnly="true" PickListName="Ticket Status" AlphaSort="true" StorageMode="ID" DisplayMode="AsText"  />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dtpCreateDate" ReadOnly="true" ButtonToolTip="<%$ resources: dtpCreateDate.ButtonToolTip %>" DisplayTime="false" DisplayMode="AsText" />
  </div>
...
<tr>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dtpCompletedDate" ReadOnly="true" ButtonToolTip="<%$ resources: dtpCompletedDate.ButtonToolTip %>" DisplayTime="false" DisplayMode="AsText" />
  </div>
...
<tr>
            <td  colspan="3" >
 <div class=" lbl colspan3 alignleft" style="margin-top:.5em;">
  ...
  <div  class="threecoltextcontrol"  style="margin-top:.5em;" >
...
<asp:Label runat="server" ID="txtResolution" style="white-space:normal"  />
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="PortalTicket_PrintView_RTools" ToolbarLocation="right">
   <a href="javascript:history.go(-1);">Back</a>
    <SalesLogix:PageLink runat="server" ID="lnkPrintView" NavigateUrl="PortalTicketDetailsPrintView"
  LinkType="PageAlias"   ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Print_View_16x16"     ToolTip="<%$ resources: lnkPrintView.ToolTip %>"     ></SalesLogix:PageLink>

  <SalesLogix:PageLink ID="btnEditForm" CssClass="adminEditFormButton" runat="server" LinkType="RelativePath" ToolTip="<%$ resources: Portal, EditForm_ToolTip %>" NavigateUrl="~/FormManager.aspx?entityid=PortalTicket_PrintView&modeid=Detail" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=form_manager_16x16"></SalesLogix:PageLink>
 
 
 
 
 <SalesLogix:PageLink ID="lnkPortalTicket_PrintViewHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="PortalTicket" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
