    ...
    */
    var widget = declare('Sage.Services.ClientBindingManagerService', null, {
        ...
        setControlFocus: function (ctrlid) {
            ...
            if (elem) {
                ...
                if (elem) {
                    ...
                    else if (dojo.style(elem, 'display') == 'none' && elem.classList.length === 0) {
                        elem = $('#' + ctrlid + ' INPUT')[3];
        ...
        registerPostBackWarningExceptions: function (elem) {
            if (elem) {
                var elems = $("a,input[type='INPUT'],input[type='BUTTON'],input[type='IMAGE'],input[type='SUBMIT']", elem).get();
