    ...
    var filterTypeWidget = declare('Sage.UI.HistoryTypeFilterWidget', [_Widget, _Templated, _WidgetsInTemplateMixin, filterMixin], {
        ...
        buildRendering: function () {
            ...
            dojo.forEach(["atAppointment", "atPhoneCall", "atToDo", "atNote", "atPersonal", "atInternal", "atSchedule", "atEMail", "atDoc", "atFax", "atLiterature", "atDatabaseChange"], function (item) {
                options.push({ name: activityUtility.getActivityTypeName(item), id: activityUtility.getActivityTypeEnumValue(item) });
            });
            ...
            var options = {
                ...
                contextualCondition: function () {
                    ...
                    if (parentRelationshipName === "ContactId" || parentRelationshipName === "LeadId") {
                        fmt = '((HistoryAttendees.EntityId eq  \'${1}\') or (${0} eq  \'${1}\' and  HistoryAttendees.IsPrimary eq true) or (${0} eq  \'${1}\' and  HistoryAttendees.EntityId eq null))';
                    }
