   ...
   nlsResources
    ...
    var activityListPanelConfig = declare('Sage.MainView.ActivityMgr.ActivityListPanelConfig', [BaseListPanelConfig], {
        ...
        constructor: function () {
            ...
            dojo.subscribe('/entity/activityAttendees/updated', this._onListRefresh);
        },
        ...
        _getSelect: function () {
            ...
            var select = [
                      ...
                      'Alarm',
                      'Status',
                      'Activity/Details/AttendeeCount'
                     ];
            return select;
      ...
      //  },
        _getStructure: function () {
            ...
            var structure = [
                ...
                { field: 'Activity.Details.AttendeeCount', name: colNameAssociationCount,  width: '90px'}
            ];
