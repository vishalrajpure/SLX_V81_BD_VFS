...
define([
    ...
    function (Link, Context, Helper, Lookup, Dialogs, MenuBar, MenuItem, PopupMenuBarItem, Utility,
        _Widget, MenuSeparator, i18n, dString, ref, regexp, dLang, nls, activityService, enumerations,
        reportingService, reportWizardController, crystalReportsUtility, declare) {
        var oMailMergeService = declare("Sage.MailMerge.Service", [_Widget], {
            ...
            // ReSharper disable UnusedParameter
                reportId, rsf, sortFields, report, params) {
                // ReSharper restore UnusedParameter
                var oService = Helper.GetMailMergeService();
                if (oService) {
                    oService.Debug("Entering HandleOnPrintAddressLabels()"); /*DNL*/
                    try {
                        oService.SetParamValue(params, "Error", ""); /*DNL*/
                        oService.SetParamValue(params, "Success", false); /*DNL*/
                        try {
                            var options = {
                                ...
                                reportOptions: {
                                    wizardOptions: {
                                        hiddenSteps: [enumerations.CrystalReportWizardStep.Conditions]
                                    },
                                    scheduleOptions: {
                        ...
                        oService.Debug("Exiting HandleOnPrintAddressLabels()"); /*DNL*/
                    }
                }
            },
            ...
            HandleOnRequestCrystalReport: function (
                reportId, sql, leftMargin, topMargin, sortFields, rsf, report, params) {
                var oService = Helper.GetMailMergeService();
                if (oService) {
