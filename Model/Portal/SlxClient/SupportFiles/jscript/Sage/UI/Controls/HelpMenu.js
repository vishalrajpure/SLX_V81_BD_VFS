    ...
    var widget = declare('Sage.UI.Controls.HelpMenu', orientableMenuBar, {    
        ...
        postCreate: function() {
            ...
            menu.addChild(new menuItem({
                ...
                onClick: function() { window.open('help/Getting Started with Saleslogix Web Client.pdf', 'MCWebHelp'); }
            }));
            menu.addChild(new menuItem({
                ...
                onClick: function() { window.open('help/Saleslogix Quick Reference for the Web User.pdf', 'MCWebHelp'); }
            }));
            menu.addChild(new menuItem({
