...
function (
   ...
   declare
    ...
    var baseListPanelConfig = declare('Sage.MainView.ReportMgr.BaseListPanelConfig', [_ConfigurationProvider], {
        list: false,
        detail: false,
        summary: false,
        toolBar: false,
        ...
        _onListRefresh: function (event) {
            //Not sure where tabId comes from, and it was causing a JSHint validation error.
            /*try {
        ...
        getFilterConfig: function (metaDataService, entry, options) {
            //TODO: this function is causing trouble
