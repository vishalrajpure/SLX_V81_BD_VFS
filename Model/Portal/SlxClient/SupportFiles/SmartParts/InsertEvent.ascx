...
<script lang="javascript" type="text/javascript">
    function ChkRequiredField() {
        ...
        else if (document.getElementById('MainContent_InsertEvent_txtDescription').value.length > 64) {
            alert("Description Length has more than 64 Characters");
            return false;
        }
        return true;
    }
...
<div style="width: 100%; height: 100%; padding-right: 10px">
    ...
    <table id="tblTest" border="0" cellpadding="1" cellspacing="2" style="width: 80%; height: 100%; padding-right: 10px">
        <tr>
            <td colspan="3">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList runat="server" ID="usrUser"  Width="128px"></asp:DropDownList>
            </td>
        </tr>
         <tr>
            <td>
            ...
            <td class="textcontrol">
                <asp:TextBox runat="server" ID="txtDescription" MaxLength="64" TextMode="MultiLine" Height="50px" Width="300px" />
            </td>
        </tr>
    </table>
</div>
