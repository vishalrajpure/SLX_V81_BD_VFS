...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
    ...
    <tr>
        <td>
            ...
            <div class="textcontrol">
                <SalesLogix:PickListControl runat="server" ID="pklAccountType" PickListId="kSYST0000382" PickListName="Account Type" AutoPostBack="true"
                    NoneEditable="true" OnPickListValueChanged="pklAccountType_PickListValueChanged" />
            </div>
        </td>
    </tr>
    <tr>
