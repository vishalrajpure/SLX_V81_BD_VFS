    ...
    <div id="filterDiv" style="display:none" runat="server">
        <table border="0" cellpadding="1" cellspacing="0" class="formtable">
            ...
            <tr>
                ...
                <td id="row1col6">
                    <div class="textcontrol select">
                        <asp:ListBox runat="server" ID="lbxStatus" data-dojo-type="Sage.UI.Controls.Select" CssClass="select-control" shouldPublishMarkDirty="false" SelectionMode="Single" Width="100%" Rows="1" EnableViewState="true" OnSelectedIndexChanged="lbxStatus_SelectedIndexChanged"></asp:ListBox>
                    </div>
                </td>
                <td id="row1col7">
                    &nbsp;</td>
