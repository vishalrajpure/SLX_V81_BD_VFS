<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddAccountAddress.ascx.cs" Inherits="SmartParts_Address_AddAccountAddress" %>
   ...
   <tr>
    ...
    <tr>
     ...
     <tr>
        ...
        <td style="width: 150px; ">
            <asp:TextBox runat="server" ID="txtLatitude" style="width: 100%" MaxLength="64" Text="0.0" />
        </td>
    </tr>
     <tr>
        <td>
        ...
        <td style="width: 150px; ">
            <asp:TextBox runat="server" ID="txtLogitute" style="width: 100%" MaxLength="64" Text="0.0" />
        </td>
    </tr>
   
</table>
<div class="button-bar alignleft">
